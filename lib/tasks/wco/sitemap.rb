...
class Wco::Sitemap
  ...
  def checks
    ...
    # ]; tmp = [
      ...
      { path: '/pages/our-team',         selector: 'article[data-history-node-id="152"]' },
      { path: '/pages/products',         selector: 'article[data-history-node-id="222"]' },
      { path: '/pages/projects',         selector: 'article[data-history-node-id="223"]' },
      { path: '/pages/public-relations', selector: 'article[data-history-node-id="115"]' },
      { path: '/pages/site-updates',     selector: 'article[data-history-node-id="151"]' },
      { path: '/pages/tutorials',        selector: 'article[data-history-node-id="221"]' },
      ...
      { path: '/services/training',                                  selector: 'article[data-history-node-id="150"]' },
